...
const RegisterPage = () => {
  ...
  const { login, error, isLoading, clearError, clearLoading } = useUserStore();
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center p-4+ md:p-0">
      <div className="hidden basis-5/12 h-screen p-4 md:block relative">
        <img
          src={bg1}
          alt=""
      ...
      <div className="md:basis-7/12 flex flex-col justify-center items-center">
        ...
        <p className="mt-4 mb-8 text-primary/60 text-sm w-full md:w-100">
          ...
          <Link to="/users/register" className="text-accent">
            Register Here
          </Link>
        </p>
        <Form {...form}>
          ...
          >
            ...
            <Button
              type="submit"
              className="w-full mt-4 p-6 bg-accent text-primary rounded-sm hover:bg-accent/80 cursor-pointer"
              disabled={isLoading}
            >
